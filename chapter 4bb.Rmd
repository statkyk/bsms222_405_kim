...
```{r}
NHANES %>% filter(Gender == "male" & AgeDecade == " 40-49") %>% group_by(Race1) %>% summarize(average_systolic_blood_pressure=mean(BPSysAve,na.rm=TRUE)) %>% arrange(average_systolic_blood_pressure)
```
