...
cbind(as.data.frame(male_percentiles),as.data.frame(female_percentiles))
```
...
```{r}
mean(79 < x & x <= 81)
pnorm((81 - m) / s) - pnorm((79 - m) / s)
mean(79 < x & x <= 81) / (pnorm((81 - m) / s) - pnorm((79 - m) / s))
```
...
```{r}
150 / ((1 - pnorm((80 - 69) / 3)) * 1000000000)
```
